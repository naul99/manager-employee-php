<?php
    ...
    header('location:../index.php');
        ...
        elseif($date > $fromdate ){
            $error=" Date invalid. Enter again! ";
            }
        elseif($date > $todate){
            $error=" Date invalid. Enter again! ";
            }
        ...
        if($lastInsertId)
        {
            ...
            $error="Sorry, Date invalid. Please enter again !";
        }
    }
    ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" value="<?php echo $fromdate ?>" data-inputmask="'alias': 'date'" required id="example-date-input" name="fromdate">
                                        </div>
